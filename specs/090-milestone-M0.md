...
- M0-5: The same T0 graph with `--embodiment so101` (scene+driver profile swap only, zero YAML edits beyond the profile key) reaches pass1 ≥ 0.80 (lower bar acknowledges hobby-arm reach). (TC-5, SCN-4.)
