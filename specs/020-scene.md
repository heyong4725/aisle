...
- SCN-3: Box placement randomized per seed on a 3-level shelf; rejection-sample any initial interpenetration; placements MUST be reachable (IK solution exists) — assert at build time.
