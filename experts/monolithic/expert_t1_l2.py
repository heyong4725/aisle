"""AISLE monolithic-arm expert for tier T1 at perception rung L2 (SPEC 440).
...
pose estimate from the overhead rgb + depth pair through the pinned
open-vocabulary detector (no segmentation mask, BND-2), a top-down or
...
MAX_RETRIES = 8  # matches graphs/expert_t1_l2.yaml AISLE_MAX_RETRIES
