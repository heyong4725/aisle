...
Renumbering note: drafted as ADR-28 on the PR #156 branch, but PR #150
(ADR identity normalization) assigned ADR-28 to the perception-rung
decision on main first. ADR-29 is this decision's unique identity; PR
#156 discussion referring to "ADR-28" means this document.
