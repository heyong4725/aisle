...
| [docs/decisions/ADR-65.md](../decisions/ADR-65.md) | ADR-65 — pilot first: a labelled pilot evidence tier and the execution order | PROPOSED (agent-drafted 2026-09-11 at the owner's direction after the |
