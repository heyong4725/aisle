...
| [docs/decisions/ADR-66.md](../decisions/ADR-66.md) | ADR-66 — pilot first: a labelled pilot evidence tier and the execution order | PROPOSED (agent-drafted 2026-09-11 at the owner's direction after the |
