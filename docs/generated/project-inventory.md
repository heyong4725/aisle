...
| [docs/decisions/ADR-30.md](../decisions/ADR-30.md) | ADR-30 — T4 dialogue contract (spec-change sketch, awaiting human review) | PROPOSED (Class-C change to SPEC 010, CON-10/CON-14 — this PR is |
