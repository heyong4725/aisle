...
- Limitations: ["No superiority, equivalence, or non-inferiority conclusion is currently allowed.", "The 2026-09-12 pilot registration (cse-causal-study-pilot-v1) collected zero sessions; every CSE-8 power input is still an assumption and the pilot's gates are all pending."]
